...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine();
        Console.WriteLine("--- Setting weather to Sunny ---");
        weatherStation.Weather = "Sunny";

        Console.WriteLine();
        Console.WriteLine("--- Setting weather to Rainy ---");
        weatherStation.Weather = "Rainy";

        // Detach one observer
        Console.WriteLine();
        Console.WriteLine("--- Detaching phone display ---");
        weatherStation.Detach(phoneDisplay);

        Console.WriteLine();
        Console.WriteLine("--- Setting weather to Cloudy ---");
